                    ...
                    <div class="card" style="border-radius: 1rem;">
                        <div class="row g-0">
                            <div class="col-md-6 col-lg-5 d-none d-md-block">
                                <img src="https://images.unsplash.com/photo-1563729784474-d77dbb933a9e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80"
                                    alt="login form" class="img-fluid" style="border-radius: 1rem 0 0 1rem;" />
                            </div>
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">

                                    <form method="POST" action="sistem/login_proses.php">
                                        ...
                                        if (isset($_GET['message'])) {
                                            if ($_GET['message'] == "failed") {
                                                ...
                                                echo "Anda harus login terlebih dahulu utk mengakses halaman ini";
                                            }
                                        }
                                        ?>
                                        </p>
                                        ...
                                        <div class="pt-1 mb-4">
                                            <button style="background-color:#ff6219;"
                                                class="btn text-light btn-lg btn-block" type="submit">Login</button>
                                        </div>
