                                    ...
                                    <div class="table-responsive table-scroll" data-mdb-perfect-scrollbar="true"
                                        ...
                                        <table class="table table-striped mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                $query = "select struk.id_struk, struk.nama_pelanggan, struk.jumlah, ekspedisi.biaya, data_roti.nama_roti, metode_bayar.kategori, struk.total_biaya from struk INNER JOIN data_roti ON struk.id_roti = data_roti.id_roti INNER JOIN ekspedisi ON struk.id_eks = ekspedisi.id_eks INNER JOIN metode_bayar ON struk.id_metode = metode_bayar.id_metode";
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a class=" btn btn-danger"
                                                            href="sistem/hapus_order.php?horder=<?= $data->id_struk ?>">Delete</a>
                                                    </td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
