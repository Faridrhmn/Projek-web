                            ...
                            <div class="card p-3">
                                <div class="card-body p-0">
                                    <div class="heading mb-5">
                                        <h2 class="text-center">Update Metode Pembayaran</h2>
                                        <h6 class="text-center mb-4">Edit pilihan metode pembayaran.</h6>
                                        <hr>
                                    </div>
                                    <?php
                                    include "sistem/koneksi.php";
                                    $emetode = $_GET['emetode'];
                                    $query = "SELECT * FROM metode_bayar where id_metode = '$emetode'";
                                    $sql = $connect->query($query);
                                    $data = $sql->fetch_object();
                                    ?>
                                    <form action="sistem/update_bayar.php" method="POST">
                                        <div class="row">
                                            ...
                                            <div class="input-form mb-4">
                                                <button name="id" value="<?=$emetode?>" type="submit"
