                            ...
                            <div class="card p-3">
                                <div class="card-body p-0">
                                    <div class="heading mb-5">
                                        <h2 class="text-center">Input Ekspedisi</h2>
                                        <h6 class="text-center mb-4">Tambahkan Pilihan Ekspedisi</h6>
                                        <hr>
                                    </div>
                                    <form action="sistem/tambah_ekspedisi.php" method="POST">
                                        <div class="row">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a class="btn btn-danger"
                                                                href="sistem/hapus_ekspedisi.php?heks=<?= $data->id_eks ?>">Delete</a>
                                                            <a class="btn btn-info"
                                                                href="edit_ekspedisi.php?eeks=<?= $data->id_eks ?>">Edit</a>
                                                        </td>
                                                    </tr>
                                                    <?php $num++;
                                                    }
