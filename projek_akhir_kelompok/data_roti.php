                            ...
                            <div class="card p-3">
                                <div class="card-body p-0">
                                    <div class="heading mb-5">
                                        <h2 class="text-center">Input Data Roti</h2>
                                        <h6 class="text-center mb-4">Tambahkan Produk Roti</h6>
                                        <hr>
                                    </div>
                                    <form action="sistem/tambah_roti.php" method="POST" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class=" form-group mb-3 col-6">
                                                <input type="text" class="col form-control"
                                                    placeholder="Masukkan Nama Roti" name="nama_roti">
                                            </div>
                                            <div class=" form-group mb-3 col-6">
                                                <input type="number" class="col form-control"
                                                    placeholder="Masukkan Harga Roti" name="harga">
                                            </div>
                                            <div class="mb-3">
                                                <input type="textarea" class="col form-control"
                                                    placeholder="Masukkan Deskripsi Roti" name="desk" rows="3">
                                                <!-- <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                                                    placeholder="Masukkan deskripsi produk"></textarea> -->
                                            </div>
                                            <div class=" form-group mb-3 col-6">
                                                <input type="file" class="col form-control" placeholder="Unggah"
                                        ...
                                        <div class="table-responsive table-scroll" data-mdb-perfect-scrollbar="true"
                                            ...
                                            <table class="table table-striped mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><?= $num ?> </td>
                                                        <td><img alt="" width="70" class="img-fluid rounded shadow-sm"
                                                                src="./img/<?php echo $data->foto; ?>""></td>
                                                        <td><?= $data->nama_roti ?></td>
                                                        <td><?= $data->harga ?></td>
                                                        <td><a class=" btn btn-danger"
                                                                href="sistem/hapus_roti.php?hroti=<?= $data->id_roti ?>">Delete</a>
                                                            <a class=" btn btn-info"
                                                                href="edit_roti.php?eroti=<?= $data->id_roti ?>">Edit</a>
                                                        </td>
                                                    </tr>
                                                    <?php $num++;
                                                    }
